...
| `email_list`, IdP group claims (`okta`, `gsuite`, `saml`, ...), service tokens | No | May over-report — see below. |
...
member of the group. Every group carrying such a rule is logged at sync
