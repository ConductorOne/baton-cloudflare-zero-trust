...
| :--- | :--- |
| Include | `email`, `email_domain`, `everyone`, `group` (nested Access group) |
...
group membership (including further nesting) is fully reflected in C1,
without this connector re-evaluating every member on every sync.
